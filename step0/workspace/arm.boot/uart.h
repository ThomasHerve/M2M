...
/**
 *  A function to enable uart interruptions
 */
void uart_irq_enable();


#define PICIntEnable 0x10140010
#define PICVectAddr 0x10140030
#define VIC_INT_ENABLE 0x010
#define UART0_IRQ 12
#define UART0_IRQ_MASK (1<<UART0_IRQ)

/**
 * A function to enable vic interruption
 */
void vic_irq_enable();
